        ...
        Ok((
            ...
            match field.get_field_type() {
                ...
                TYPE_FIXED32 => {
                    ...
                    parse_vec!(target, field.get_label(), Value::UInt32)
                }
                TYPE_BOOL => {
                    let mut target = Vec::new();
